...
@Component({
    template: `
        <div>
            <button data-value="10" (click)="handleLoad($event)">
                Load 10
            </button>
            <button data-value="100" (click)="handleLoad($event)">
                Load 100
            </button>
            <button data-value="500" (click)="handleLoad($event)">
                Load 500
            </button>
        </div>
        <div>
