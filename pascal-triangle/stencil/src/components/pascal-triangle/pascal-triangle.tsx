...
export class PascalTriangle {
  ...
  render() {
    return (
      <div>
        <div>
          <button data-value="10" onClick={ev => this._handleLoad(ev)}>
            Load 10
          </button>
          <button data-value="100" onClick={ev => this._handleLoad(ev)}>
            Load 100
          </button>
          <button data-value="500" onClick={ev => this._handleLoad(ev)}>
            Load 500
          </button>
        </div>
        <div>
