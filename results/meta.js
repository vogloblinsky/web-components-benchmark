...
module.exports = {
    wc: [{
        ...
        todo: {
            ...
            paths: [
                'todomvc/native-shadow-dom_hyperHTML/dist/bundle.js'
            ]
        }
    }, {
        name: 'LitElement',
        ...
        todo: {
            ...
            paths: [
                'todomvc/lit-element/dist/bundle.js'
            ]
        }
    }, {
        name: 'Polymer 3',
        ...
        todo: {
            ...
            paths: [
                'todomvc/polymer3/build/es6-unbundled/bundle.js'
            ]
        }
    }, {
        name: 'Riot',
        ...
        todo: {
            ...
            paths: [
                'todomvc/skatejs-lit-html/dist/main.js'
            ]
        }
    }, {
        name: 'SkateJS & Preact',
        ...
        todo: {
            url: 'skatejs-preact/',
            paths: [
                'todomvc/skatejs-preact/dist/main.js'
            ]
        }
    }, {
        name: 'Slim.js',
        ...
        todo: {
            ...
            paths: [
                'todomvc/slim.js/dist/bundle.js'
            ]
        }
    }, {
        name: 'Stencil',
        ...
        todo: {
            ...
            paths: [
                ...
                `todomvc/stencil/www/build/app/${stencilTodoInfos.components['my-todo'].bundleIds.$}.entry.js`,
                `todomvc/stencil/www/build/app/${stencilTodoInfos.components['todo-input'].bundleIds.$}.entry.js`,
                `todomvc/stencil/www/build/app/${stencilTodoInfos.components['todo-item'].bundleIds.$}.entry.js`
            ]
        }
    }, {
        name: 'Svelte',
        ...
        todo: {
            ...
            paths: [
                'todomvc/svelte/public/bundle.js'
            ]
        }
    }],
    fw: [{
        ...
        todo: {
            ...
            paths: [
                'todomvc/dojo2/output/dist/todo-app/todo-app-1.0.0.js',
                'todomvc/dojo2/output/dist/todo-input/todo-input-1.0.0.js',
                'todomvc/dojo2/output/dist/todo-item/todo-item-1.0.0.js'
            ]
        }
    }]
};